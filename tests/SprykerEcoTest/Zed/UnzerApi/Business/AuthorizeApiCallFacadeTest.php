 ...
 * @group Business
 */
class AuthorizeApiCallFacadeTest extends UnzerApiFacadeBaseTest
{
    /**
     * @var string
     */
    ...
    public function testPerformAuthorizeApiCall(): void
    {
        ...
        $unzerApiCreateBasketResponseTransfer = $unzerApiResponseTransfer->getAuthorizeResponseOrFail();
