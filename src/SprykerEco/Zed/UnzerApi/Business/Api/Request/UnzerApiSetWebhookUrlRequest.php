...
class UnzerApiSetWebhookUrlRequest extends UnzerApiAbstractRequest implements UnzerApiRequestInterface
{
    /**
    ...
    {
        return $this->unzerApiConfig->getUnzerApiSetWebhookUrl();
    }
