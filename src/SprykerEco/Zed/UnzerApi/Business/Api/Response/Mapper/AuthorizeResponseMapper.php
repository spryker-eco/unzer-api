...
class AuthorizeResponseMapper implements UnzerApiResponseMapperInterface
{
    ...
    /**
     * @param array $responseData
     * @param \Generated\Shared\Transfer\UnzerApiAuthorizeResponseTransfer $responseTransfer
     *
    ...
    protected function mapMessageDataToUnzerApiAuthorizeResponseTransfer(
        array $responseData,
        UnzerApiAuthorizeResponseTransfer $responseTransfer
    ): UnzerApiAuthorizeResponseTransfer {
        if (!$responseData) {
        ...
        return $responseTransfer->setMessage($unzerApiMessageTransfer);
    }
